...
TEST(RoSeCameraTest, testSetMatrix) {
    ...
    cam.getCameraParameters(gold_params[0], gold_params[1], gold_params[2], gold_params[3],
                            gold_params[4]);

    cam.setMatrix(cam.matrix());
    Eigen::Matrix4f result = cam.matrix();
    cam.getCameraParameters(result_params[0], result_params[1], result_params[2], result_params[3],
                            result_params[4]);
