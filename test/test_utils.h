...
public:
    ...
    /** \brief Returns a random float from the Gaussian distribution with mean 0 and std. deviation
     * 1 */
    ...
    /** \brief Returns a random double from the Gaussian distribution with mean 0 and std. deviation
     * 1 */
